...
1. Clone Repositori ini:
   ```bash
    mkdir -p ros2-navigation-bt
    cd ros2-navigation-bt
    git clone https://github.com/Ftryasalsa/ros2-navigation-behavoir-tree.git
    cd src\nav2_mobile_robot
    git clone https://github.com/abubakar-mughal97/nav2_mobile_robot.git
    ```
2. Build Workspace:
   ```bash
    colcon build
...
5. Jalankan Eksekutor Behavior Tree:
   ```bash
    ...
    ```
# 🎥 Demo Video
(https://youtu.be/njvZOTyr-rw?si=eh2PfkAEmWnOX6yI)
